...
public class Base64 {
    ...
    public static void main(String[] args) throws Exception {
        String encBankAcctNo = "6214832130567956"; //加密的银行账号
        String encBankAcctName = "刘天平"; //加密的银行账户名
        //注意 这里的  pksc8_public.pem  是上一步获取微信支付公钥后经openssl 转化成PKCS8格式的公钥
        String keyfile = "C:/Users/xym/Desktop/newPublic.pem"; //读取PKCS8密钥文件
        ...
        byte[] estr2 = RSAUtil.encrypt(encBankAcctName.getBytes(), pub, 2048, 11, rsa);   //对银行账号进行加密
        encBankAcctName = Base64.encode(estr2);
